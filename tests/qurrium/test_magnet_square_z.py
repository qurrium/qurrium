"""Test the Qurrium Runtime :class:`ZDirMagnetSquare`.

It's from :class:`~qurry.qurry.qurries.magnet_square_z.qurry.ZDirMagnetSquare`.
"""
...
def test_measure_and_analyze(
    ...
    Args:
        case_entries (CaseEntriesTuple[ZMSMeasureArgs, ZMSAnalyzeArgs]): The test case item.
    """
...
def test_multi_output_all() -> None:
    ...
    test_report: dict[tuple[str, ...], list[ZMSAnalysis]] = exp_method.multimanagers[
        summoner_id
