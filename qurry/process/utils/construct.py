...
try:
    ...
    counts_under_degree_rust_source = construct.single_counts_under_degree_rust
    counts_list_under_degree_rust_source = construct.counts_list_under_degree_rust
    shot_counts_selected_clreg_checker_source = construct.shot_counts_selected_clreg_checker
