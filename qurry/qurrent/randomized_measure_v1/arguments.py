...
class EntropyMeasureRandomizedV1Arguments(ArgumentsPrototype):
    """Arguments for
    :class:`~qurry.qurrent.randomized_measure_v1.experiment.EntropyMeasureRandomizedV1Experiment`.
    """
...
class EntropyMeasureRandomizedV1MeasureArgs(BasicArgs, total=False):
    """Input fields for
    :meth:`~qurry.qurrent.randomized_measure_v1.qurry.EntropyMeasureRandomizedV1.measure`
...
class EntropyMeasureRandomizedV1OutputArgs(OutputArgs):
    ...
    :meth:`~qurry.qurrent.randomized_measure_v1.qurry.EntropyMeasureRandomizedV1.output`."""
...
class EntropyMeasureRandomizedV1AnalyzeArgs(AnalyzeArgs, total=False):
    ...
    :meth:`~qurry.qurrent.randomized_measure_v1.\
experiment.EntropyMeasureRandomizedV1Experiment.analyze`.
    """
