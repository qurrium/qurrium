"""EchoListenRandomized - Analysis (:mod:`qurry.qurrech.randomized_measure.analysis`)"""
...
class ELRAnalyzeArgs(AnalyzeArgs, total=False):
    ...
    :meth:`~qurry.qurrech.randomized_measure.experiment.ELRExperiment.analyze`.
    """
...
class ELROverlapResult(AnalysisResultsPrototype):
    """The default results of :class:`~qurry.qurrech.randomized_measure.analysis.ELRAnalysis`,
