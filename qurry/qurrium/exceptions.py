...
class OldFormatedIncompatibleWarning(QurryWarning):
    """Warning for old formatted incompatible Qurrium realization."""


MSG_V7_FILE_FORMAT_INCOMPATIBLE = (
    "The Qurrium files format for reports and side products "
    "has been updated since version 0.15.0. "
    "The old formatted files generated by Qurrium version 0.14.x or earlier "
    "are incompatible with the current Qurrium version during reading. "
    "But those old formatted files will still be kept unchanged in your storage. "
    "If you urgently need to read those old formatted files, "
    "please directly email to the main author Huai-Chun "
    "to <harui2019@qurrium.org> or <harui2019@proton.me>."
)
