...
class SUAnalyzeArgs(AnalyzeArgs, total=False):
    ...
    :meth:`~qurry.qurrent.classical_shadow.experiment.SUExperiment.analyze`.
    """
...
class SUBasicResult(AnalysisResultsPrototype):
    """The target system result of :class:`~qurry.qurshady.classical_shadow.analysis.SUAnalysis`."""
...
class SUPurityResult(AnalysisResultsPrototype):
    """The purity result of :class:`~qurry.qurshady.classical_shadow.analysis.SUAnalysis`."""
...
class SUEstimationResult(AnalysisResultsPrototype):
    """The estimation result of :class:`~qurry.qurshady.classical_shadow.analysis.SUAnalysis`."""
...
class SUAnalysis(
    ...
    :class:`~qurry.qurshady.classical_shadow.experiment.SUExperiment`."""
